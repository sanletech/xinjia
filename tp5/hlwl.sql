...
<<<<<<< HEAD
=======
Date: 2018-08-26 23:46:34
>>>>>>> fa0c3f2c718be4154b12aee2c758e2514786d726
*/

SET FOREIGN_KEY_CHECKS=0;

-- ----------------------------
-- Table structure for `hi_order_add_copy`
-- ----------------------------
DROP TABLE IF EXISTS `hi_order_add_copy`;
CREATE TABLE `hi_order_add_copy` (
  `id` int(10) NOT NULL,
  `order_sum_code` int(11) DEFAULT NULL COMMENT '一个集装箱的订单id',
  `send_id` int(10) DEFAULT NULL COMMENT '收货人linkman_id',
  `receive_id` int(10) DEFAULT NULL COMMENT '收货人linkman_id',
  `order_num` int(11) DEFAULT NULL COMMENT '订单号码',
  `track_num` int(15) DEFAULT NULL COMMENT '运单号码',
  `oder_price_id` int(4) DEFAULT NULL COMMENT '车收货船运货车送货的order_price价格id',
  `mtime` int(11) DEFAULT NULL,
  `cargo` varchar(255) DEFAULT NULL COMMENT '货名',
  `container_num` int(4) DEFAULT NULL COMMENT '一票需要的集装箱数量',
  `weight` int(11) DEFAULT NULL COMMENT '一票柜子的总重量',
  `file` int(11) DEFAULT NULL COMMENT '是否需要箱内会单1需要2不需要',
  `amount_covery` int(11) DEFAULT NULL COMMENT '一柜货物保险金额',
  `payer` int(2) DEFAULT NULL COMMENT '1发货方付款, 收货方付款',
  `payment_method` int(11) DEFAULT NULL COMMENT '收款方式,月结,押货,先钱后送',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of hi_order_add_copy
-- ----------------------------
INSERT INTO `hi_order_add_copy` VALUES ('1', '123456789', '1', '2', null, '111111', '1', null, null, null, null, null, null, null, null);
INSERT INTO `hi_order_add_copy` VALUES ('2', '123456789', '110101001', '120101004', null, '222255', '1', null, null, null, null, null, null, null, null);
...
-- ----------------------------
INSERT INTO `hl_auth_group` VALUES ('1', '显示按钮', '1', '1');
...
-- ----------------------------
INSERT INTO `hl_auth_rule` VALUES ('1', 'show_buton', '显示按钮', '1', '');
...
-- ----------------------------
INSERT INTO `hl_cardata` VALUES ('1', '飞机', '撒旦发射', '1', '1', '1526882031');
INSERT INTO `hl_cardata` VALUES ('2', '火车', '不知名或许', '4', '2', '1525761231');
INSERT INTO `hl_cardata` VALUES ('3', '宝马', '防守对方是否', '3', '2', '1525685928');
INSERT INTO `hl_cardata` VALUES ('4', '单车', '大飞', '3', '2', '1526635672');
INSERT INTO `hl_cardata` VALUES ('5', '公交', '速读法', '3', '2', '1524726443');
INSERT INTO `hl_cardata` VALUES ('6', '马自达', '的说法撒旦', '3', '2', '1524726478');
INSERT INTO `hl_cardata` VALUES ('7', '饿了没', '圣达菲卡', '3', '2', '1524731566');
INSERT INTO `hl_cardata` VALUES ('8', '饿了么', '撒旦法', '4', '2', '1525761815');
INSERT INTO `hl_cardata` VALUES ('9', '饿了吧', '撒旦法', '4', '2', '1525761842');
INSERT INTO `hl_cardata` VALUES ('10', '还没饿', '盛大发售的方式', '4', '2', '1525761919');
INSERT INTO `hl_cardata` VALUES ('11', '饿了不', 'aaaaaaaa', '1', '1', '1525761984');
INSERT INTO `hl_cardata` VALUES ('12', '饿了哦', 'dddd', '4', '1', '1525762731');
INSERT INTO `hl_cardata` VALUES ('13', '百度外卖', '阿萨德分', '3', '2', null);
INSERT INTO `hl_cardata` VALUES ('14', '滴滴', '阿萨德发生', '2', '2', '1525770089');
INSERT INTO `hl_cardata` VALUES ('15', '快递', '阿萨德发生', '2', '2', '1525770089');
INSERT INTO `hl_cardata` VALUES ('16', '查水表', '阿萨德发生', '2', '2', '1525770089');
INSERT INTO `hl_cardata` VALUES ('17', '天天快递', '阿萨德发生', '2', '2', '1525770089');
INSERT INTO `hl_cardata` VALUES ('18', '顺风快递', '阿萨德发生', '2', '2', '1525770089');
INSERT INTO `hl_cardata` VALUES ('19', '不饿了', '阿萨德发生', '2', '2', '1525770089');
INSERT INTO `hl_cardata` VALUES ('20', ' aaa', '撒旦发射', '4', '2', '1528785846');
...
-- ----------------------------
-- Table structure for `hl_carline1`
-- ----------------------------
DROP TABLE IF EXISTS `hl_carline1`;
CREATE TABLE `hl_carline1` (
  `id` int(10) NOT NULL AUTO_INCREMENT COMMENT '车运目的地',
  `cl_start` varchar(20) DEFAULT NULL COMMENT '车运始发地',
  `cl_over` varchar(20) DEFAULT NULL COMMENT '车运目的地',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of hl_carline1
-- ----------------------------

-- ----------------------------
-- Table structure for `hl_carline2`
-- ----------------------------
DROP TABLE IF EXISTS `hl_carline2`;
CREATE TABLE `hl_carline2` (
  `id` int(10) NOT NULL AUTO_INCREMENT COMMENT '车运目的地',
  `cl2_start` varchar(20) DEFAULT NULL COMMENT '车运始发地',
  `cl2_over` varchar(20) DEFAULT NULL COMMENT '车运目的地',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of hl_carline2
-- ----------------------------
...
-- ----------------------------
INSERT INTO `hl_carprice` VALUES ('30', '33', '5', '1000.00', '111111112.00', null, 'r', '1528782891');
INSERT INTO `hl_carprice` VALUES ('31', '33', '6', '200.00', '2000.00', null, 's', '1528782891');
INSERT INTO `hl_carprice` VALUES ('32', '31', '5', '5000.00', '55555.00', null, 'r', '1528783034');
INSERT INTO `hl_carprice` VALUES ('33', '31', '5', '555.00', '445454.00', null, 's', '1528783034');
INSERT INTO `hl_carprice` VALUES ('34', '32', '1', '2000.00', '4111.00', null, 'r', '1530002159');
INSERT INTO `hl_carprice` VALUES ('35', '32', '2', '1220.00', '455000.00', null, 's', '1530002159');
INSERT INTO `hl_carprice` VALUES ('36', '35', '1', '500.00', '1000.00', null, 'r', '1530071239');
INSERT INTO `hl_carprice` VALUES ('37', '35', '2', '500.00', '1200.00', null, 's', '1530071239');
INSERT INTO `hl_carprice` VALUES ('38', '36', '8', '800.00', '1600.00', null, 'r', '1530071320');
INSERT INTO `hl_carprice` VALUES ('39', '36', '11', '800.00', '1700.00', null, 's', '1530071320');
INSERT INTO `hl_carprice` VALUES ('42', '37', '5', '500.00', '1000.00', null, 'r', '1530172947');
INSERT INTO `hl_carprice` VALUES ('43', '37', '13', '550.00', '1200.00', null, 's', '1530172947');
INSERT INTO `hl_carprice` VALUES ('44', '38', '5', '600.00', '1500.00', null, 'r', '1530172993');
...
-- ----------------------------
DROP TABLE IF EXISTS `hl_carprice1`;
CREATE TABLE `hl_carprice1` (
  `id` int(10) NOT NULL AUTO_INCREMENT COMMENT '车队送货到港口价格表',
  `cl_id` int(20) DEFAULT NULL COMMENT '车运路线ID',
  `container_id` int(20) DEFAULT NULL COMMENT '集装箱种类',
  `fare` double(20,0) DEFAULT NULL COMMENT '运货费用',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of hl_carprice1
-- ----------------------------

-- ----------------------------
-- Table structure for `hl_carprice2`
-- ----------------------------
DROP TABLE IF EXISTS `hl_carprice2`;
CREATE TABLE `hl_carprice2` (
  `id` int(10) NOT NULL AUTO_INCREMENT COMMENT '车队从港口装货价格表',
  `cl2_id` int(20) DEFAULT NULL COMMENT '车运路线ID',
  `container_id` int(20) DEFAULT NULL COMMENT '集装箱种类',
  `fare2` double(20,0) DEFAULT NULL COMMENT '运货费用',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of hl_carprice2
-- ----------------------------
...
-- ----------------------------
INSERT INTO `hl_car_receive` VALUES ('3', 'ADSFASD', null, '美团', '王大成', '粤AAA', '4454646464', '123456789', 'guihao1111', null, 's6fa4sd6f', '司法所', '1530633600', null, '0000-00-00 00:00:00');
INSERT INTO `hl_car_receive` VALUES ('4', 'ADSFASD', null, '饿了么', '王大妈', '粤BBB', '464646464', '123456789', 'guihao222', null, '6sd5fa4s6', '阿斯蒂芬', '1531238400', null, '0000-00-00 00:00:00');
INSERT INTO `hl_car_receive` VALUES ('5', 'YYYYY', null, 'aa', 'aaa', 'aaa', 'aa', 'aaaaaaaa', '565', null, '45646', 'gasf', '1531238400', null, '0000-00-00 00:00:00');
INSERT INTO `hl_car_receive` VALUES ('16', 'ADSFASD', null, '饿了没', '王大成', '粤BAKSD', '4444444546546', '1857555555', 'GUIZI44444', null, 'FDSF564', '王大哥', '1531152000', '0000-00-00 00:00:00', '0000-00-00 00:00:00');
INSERT INTO `hl_car_receive` VALUES ('17', 'ADSFASD', null, '饿了不', '玩的人', '粤BAKSD', '4444546446', '18555566464', 'GUIZI5555555', null, 'AS6D5F4', '李大哥', '1531152000', '0000-00-00 00:00:00', '0000-00-00 00:00:00');
INSERT INTO `hl_car_receive` VALUES ('18', 'ZHY1817NSKRZ031', null, '美团队', '王大爷', '粤DSBDSB', '56464654', '46464', 'asdf545456465', null, '46464', '王大勇', null, '0000-00-00 00:00:00', null);
INSERT INTO `hl_car_receive` VALUES ('19', 'ZHY1817NSKRZ035', null, '美人队', '王大哥', '粤SBSBSBS', '4546545464', '46454', 'fassd2545456465', null, '646546', '王大爷', null, '0000-00-00 00:00:00', null);
INSERT INTO `hl_car_receive` VALUES ('20', 'YYYYY', null, 'sdfads', 'asdfas', 'asdfads', 'asfsad', 'fsadfasfs', 'aasdfasf', null, 'fasdfas', 'asdfasf', '1534867200', '0000-00-00 00:00:00', '0000-00-00 00:00:00');
INSERT INTO `hl_car_receive` VALUES ('21', 'YUN78945655', null, '司机姓名', '司机姓名', 'ASDFA ', '4564654SDFAS', '185855', '185855', null, '185855', 'SDF5A6SF4', '1533657600', null, '0000-00-00 00:00:00');
INSERT INTO `hl_car_receive` VALUES ('22', 'YUN78945655', null, '司机姓名', '司机姓名', 'FSDFSD', '545646FASF', '185855', '185855', null, '185855', '56F4ASDF6', '1534348800', null, '0000-00-00 00:00:00');
INSERT INTO `hl_car_receive` VALUES ('23', 'YUN78945655', null, '司机姓名', '司机姓名', 'SDFASDF', '46546DFASDF', '185855', '185855', null, '185855', '4654FA6SD', '1534262400', null, '0000-00-00 00:00:00');
INSERT INTO `hl_car_receive` VALUES ('24', 'AAAAAAAA', null, '司机一个', '司机一个', '4554sadf', '4564654646', '654654564', '6465464', null, '46464', '士大夫', '2018-08-22', '2018-09-07 00:00:00', '2018-08-26 11:10:14');
INSERT INTO `hl_car_receive` VALUES ('25', 'AAAAAAAA', null, '司机一个', '司机一个', '5sad4fa', '4646464', '4654646', '46464', null, '6464', '发射点', '2018-08-21', '2018-09-07 00:00:00', '2018-08-26 11:10:14');
INSERT INTO `hl_car_receive` VALUES ('26', 'AAAAAAAA', null, '司机一个', '司机一个', 'sadf56as', '4646464', '4646546', '464641', null, '46464', '发士大夫', '2018-08-15', '2018-09-07 00:00:00', '2018-08-26 11:10:14');
...
-- ----------------------------
-- Table structure for `hl_car_ship_port----a`
-- ----------------------------
DROP TABLE IF EXISTS `hl_car_ship_port----a`;
CREATE TABLE `hl_car_ship_port----a` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `port_id` int(10) DEFAULT NULL COMMENT '港口ID',
  `ship_id` int(10) DEFAULT NULL COMMENT '船公司ID',
  `car_data_id` int(10) NOT NULL COMMENT '车队id',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=21 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of hl_car_ship_port----a
-- ----------------------------
INSERT INTO `hl_car_ship_port----a` VALUES ('1', '13', '1', '1');
INSERT INTO `hl_car_ship_port----a` VALUES ('2', '13', null, '2');
INSERT INTO `hl_car_ship_port----a` VALUES ('3', '14', '4', '3');
INSERT INTO `hl_car_ship_port----a` VALUES ('4', '15', '5', '4');
INSERT INTO `hl_car_ship_port----a` VALUES ('5', '6', '6', '5');
INSERT INTO `hl_car_ship_port----a` VALUES ('6', '3', '1', '6');
INSERT INTO `hl_car_ship_port----a` VALUES ('7', '5', '3', '8');
INSERT INTO `hl_car_ship_port----a` VALUES ('8', '2', '5', '9');
INSERT INTO `hl_car_ship_port----a` VALUES ('9', '13', '1', '10');
INSERT INTO `hl_car_ship_port----a` VALUES ('10', '14', '5', '1');
INSERT INTO `hl_car_ship_port----a` VALUES ('11', '15', '6', '2');
INSERT INTO `hl_car_ship_port----a` VALUES ('12', '6', '2', '3');
INSERT INTO `hl_car_ship_port----a` VALUES ('13', '14', '1', '4');
INSERT INTO `hl_car_ship_port----a` VALUES ('14', '15', '4', '5');
INSERT INTO `hl_car_ship_port----a` VALUES ('15', '9', '2', '6');
INSERT INTO `hl_car_ship_port----a` VALUES ('16', '13', '1', '7');
INSERT INTO `hl_car_ship_port----a` VALUES ('17', '14', '0', '8');
INSERT INTO `hl_car_ship_port----a` VALUES ('18', '15', '0', '9');
INSERT INTO `hl_car_ship_port----a` VALUES ('19', '6', '1', '10');
INSERT INTO `hl_car_ship_port----a` VALUES ('20', '6', '1', '11');
...
INSERT INTO `hl_member` VALUES ('6', '客户李七', 'e10adc3949ba59abbe56e057f20f883e', '0000-00-00', '0000-00-00', '18575280024', 'asaa@qq.com', '0', null, '0000-00-00', '3', '外包公司', 'kehu006', 'company');
...
INSERT INTO `hl_member` VALUES ('14', '王达成', 'e10adc3949ba59abbe56e057f20f883e', '2018-08-25', '0000-00-00', '18575280024', '', '0', null, null, null, '黄金宇宙', 'taobao', 'company');
...
CREATE TABLE `hl_member_profit` (
  ...
  `money` int(10) DEFAULT '200' COMMENT '提成点',
  `mtime` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=18 DEFAULT CHARSET=utf8;
...
-- ----------------------------
INSERT INTO `hl_member_profit` VALUES ('1', 'kehu001', '1', '201', '2018-08-26 08:35:53');
INSERT INTO `hl_member_profit` VALUES ('2', 'kehu001', '2', '202', '2018-08-26 08:35:53');
INSERT INTO `hl_member_profit` VALUES ('3', 'kehu001', '3', '203', '2018-08-26 08:35:53');
INSERT INTO `hl_member_profit` VALUES ('4', 'kehu001', '4', '204', '2018-08-26 08:35:53');
INSERT INTO `hl_member_profit` VALUES ('5', 'kehu001', '5', '205', '2018-08-26 08:35:53');
INSERT INTO `hl_member_profit` VALUES ('6', 'kehu001', '6', '206', '2018-08-26 08:35:53');
INSERT INTO `hl_member_profit` VALUES ('7', 'kehu001', '7', '207', '2018-08-26 08:35:53');
...
INSERT INTO `hl_member_profit` VALUES ('14', 'taobao6', '4', '200', '2018-08-26 10:41:45');
INSERT INTO `hl_member_profit` VALUES ('15', 'taobao6', '5', '200', '2018-08-26 10:41:45');
INSERT INTO `hl_member_profit` VALUES ('16', 'taobao6', '6', '200', '2018-08-26 10:41:45');
INSERT INTO `hl_member_profit` VALUES ('17', 'taobao6', '7', '200', '2018-08-26 10:41:45');

-- ----------------------------
-- Table structure for `hl_member_profit_copy`
-- ----------------------------
DROP TABLE IF EXISTS `hl_member_profit_copy`;
CREATE TABLE `hl_member_profit_copy` (
...
-- ----------------------------
-- Records of hl_member_profit_copy
-- ----------------------------
INSERT INTO `hl_member_profit_copy` VALUES ('100', '200', '2000', '400', '100', '200', '150', 'kehu001', '1');
INSERT INTO `hl_member_profit_copy` VALUES ('100', '200', '200', '200', '200', '250', '250', 'kehu002', '2');
INSERT INTO `hl_member_profit_copy` VALUES ('100', '200', '200', '200', '200', '200', '100', 'kehu003', '3');
INSERT INTO `hl_member_profit_copy` VALUES ('100', '200', '200', '200', '200', '200', '100', 'kehu004', '4');
INSERT INTO `hl_member_profit_copy` VALUES ('100', '200', '200', '200', '200', '200', '100', 'kehu005', '5');
INSERT INTO `hl_member_profit_copy` VALUES ('100', '200', '200', '200', '200', '200', '100', 'kehu006', '6');
INSERT INTO `hl_member_profit_copy` VALUES ('100', '200', '200', '200', '200', '200', '100', 'kehu007', '7');
INSERT INTO `hl_member_profit_copy` VALUES ('100', '200', '200', '200', '200', '200', '100', 'kehu008', '8');
INSERT INTO `hl_member_profit_copy` VALUES ('100', '200', '200', '200', '200', '200', '100', 'kehu009', '9');
INSERT INTO `hl_member_profit_copy` VALUES ('100', '200', '200', '200', '200', '200', '100', 'kehu0010', '10');
...
-- ----------------------------
INSERT INTO `hl_order_comment` VALUES ('1', '1531116252kehu001992', '1', '1', '2', '9', '1', '1', '0000-00-00 00:00:00');
INSERT INTO `hl_order_comment` VALUES ('2', '1531118326kehu001205', '势必就是_10086', '2', '1', '9', '1', '1', '0000-00-00 00:00:00');
INSERT INTO `hl_order_comment` VALUES ('3', '1531118344kehu001875', '势必就是_10086', '2', '1', '9', '1', '1', '0000-00-00 00:00:00');
INSERT INTO `hl_order_comment` VALUES ('4', '1531119660kehu001132', '2', '2', '2', '9', '1', '1', '0000-00-00 00:00:00');
INSERT INTO `hl_order_comment` VALUES ('5', '1531190282kehu001737', '三大发射的_10086', '1', '1', '9', '1', '1', '0000-00-00 00:00:00');
...
-- ----------------------------
INSERT INTO `hl_order_father` VALUES ('1', '201806251702', '钢筋', '1', '2', '2000', '8848', '5', '这个是针对订单具体信息', '0000-00-00 00:00:00', '2', '1', 'kehu001', null, '800', null);
INSERT INTO `hl_order_father` VALUES ('2', '201806251705', '牲畜', '2', '1', '8000', '54321', '2', '这是一个订单下另一种货物', '0000-00-00 00:00:00', '1', '2', 'kehu002', null, '400', null);
INSERT INTO `hl_order_father` VALUES ('3', '1531107265kehu001555', '钢材', '1', '2', '410', '142', '1', '阿萨德发送到发送', '0000-00-00 00:00:00', '1', '5', 'kehu001', null, '400', null);
INSERT INTO `hl_order_father` VALUES ('4', '1531118326kehu001205', '木头', '1', '3', '100', '50', '1', '卖家必须要发货速度块', '0000-00-00 00:00:00', '1', '1', 'kehu001', null, '300', null);
INSERT INTO `hl_order_father` VALUES ('5', '1531118344kehu001875', '木头', '1', '3', '100', '50', '1', '卖家必须要发货速度块', '0000-00-00 00:00:00', '1', '1', 'kehu001', null, '100', null);
INSERT INTO `hl_order_father` VALUES ('6', '1531119660kehu001132', '黄金沙子', '1', '1', '100', '1000', '1', '昂贵物品丢失不赔', '0000-00-00 00:00:00', '1', '1', 'kehu001', null, '100', null);
INSERT INTO `hl_order_father` VALUES ('7', '1531190282kehu001737', '饮料', '1', '3', '100', '100', '2', '发货所得税法撒旦法', '0000-00-00 00:00:00', '1', '3', 'kehu001', null, '800', null);
INSERT INTO `hl_order_father` VALUES ('8', 'A824106096329230', 'aaa', '1', '7', '600', '100', '2', '订单备注 ,要注意冷冻保存', '2018-05-05 00:00:00', '1', '4', 'kehu001', null, '0', null);
INSERT INTO `hl_order_father` VALUES ('9', 'A826921016606912', '猪肉', '40HQ', '3', '100', '100', '1', '测试订单测试订单', '2018-08-26 11:45:08', '1', '1', 'taobao6', null, '400', '录完实际装货时间>待配船');
INSERT INTO `hl_order_father` VALUES ('10', 'A826944504106855', '猪肉', '40HQ', '3', '100', '100', '1', '测试订单测试订单', '2018-08-26 22:40:50', '1', '1', 'taobao6', null, '0', null);
...
-- ----------------------------
INSERT INTO `hl_order_ship` VALUES ('1', '1531107265kehu001555', null, null, null, '空城计', '110100003', null, null, '丑八怪', '110100005', null, null, 'W_R_R_R_R_R_R', null, '1');
INSERT INTO `hl_order_ship` VALUES ('2', '1531107265kehu001555', null, null, null, '丑八怪', '110100005', null, null, '美人计', '110100006', null, null, 'R_R_R_R_R_R_R', null, '2');
INSERT INTO `hl_order_ship` VALUES ('3', '1531107265kehu001555', null, null, null, '美人计', '110100006', null, null, '里程碑', '110100007', null, null, 'R_R_R_R_R_R_R', null, '3');
INSERT INTO `hl_order_ship` VALUES ('4', '1531107265kehu001555', null, null, null, '里程碑', '110100007', null, null, '擎天柱', '110100002', null, null, 'R_R_R_R_R_R_R', null, '4');
...
-- ----------------------------
DROP TABLE IF EXISTS `hl_order_son`;
CREATE TABLE `hl_order_son` (
...
-- ----------------------------
INSERT INTO `hl_order_son` VALUES ('1', '201806251702', 'ZHY1817NSKRZ031', 'asdf545456465', '400', null, '5', null, null, null);
INSERT INTO `hl_order_son` VALUES ('2', '201806251702', 'ZHY1817NSKRZ035', 'fassd2545456465', '400', null, '6', null, null, null);
INSERT INTO `hl_order_son` VALUES ('9', '201806251705', 'YYYYY', 'aasdfasf', '400', null, '20', null, null, null);
INSERT INTO `hl_order_son` VALUES ('18', '1531107265kehu001555', 'ADSFASD', 'ANNSTIA180491174', '505', null, '16', null, null, null);
INSERT INTO `hl_order_son` VALUES ('21', '1531107265kehu001555', 'ADSFASD', 'ANNSTIA180491175', '505', null, '17', '', null, null);
INSERT INTO `hl_order_son` VALUES ('22', '1531190282kehu001737', '5806863751', '5806863751d0820n0', '800', null, null, null, null, null);
INSERT INTO `hl_order_son` VALUES ('23', '1531190282kehu001737', '5806863751', '5806863751d0820n1', '800', null, null, null, null, null);
INSERT INTO `hl_order_son` VALUES ('24', '1531190282kehu001737', '5806863751', '5806863751d0820n2', '505', null, null, null, null, null);
INSERT INTO `hl_order_son` VALUES ('25', '1531118326kehu001205', 'YUN78945655', '185855', '300', null, '21', null, null, null);
INSERT INTO `hl_order_son` VALUES ('26', '1531118326kehu001205', 'YUN78945655', '185855', '300', null, '21', null, null, null);
INSERT INTO `hl_order_son` VALUES ('27', '1531118326kehu001205', 'YUN78945655', '185855', '300', null, '21', null, null, null);
INSERT INTO `hl_order_son` VALUES ('28', 'A826921016606912', 'AAAAAAAA', '6465464', '400', '录完实际装货时间>待配船', '24', null, null, '2018-08-26 11:45:08');
INSERT INTO `hl_order_son` VALUES ('29', 'A826921016606912', 'AAAAAAAA', '46464', '400', '录完实际装货时间>待配船', '25', null, null, '2018-08-26 11:45:08');
INSERT INTO `hl_order_son` VALUES ('30', 'A826921016606912', 'AAAAAAAA', '464641', '400', '录完实际装货时间>待配船', '25', null, null, '2018-08-26 11:45:08');
...
-- ----------------------------
INSERT INTO `hl_order_status` VALUES ('1', '3', '1532917607', '3', null, '录入派车信息完毕', 'aaa');
INSERT INTO `hl_order_status` VALUES ('2', '3', '1532917607', null, '18', '录入派车信息完毕', 'aaa');
INSERT INTO `hl_order_status` VALUES ('3', '3', '1532917607', null, '21', '录入派车信息完毕', 'aaa');
...
INSERT INTO `hl_order_status` VALUES ('27', '4', '1533625473', '1', null, '录入实际装货时间完毕', 'aaa');
INSERT INTO `hl_order_status` VALUES ('28', '4', '1533625473', null, '1', '录入实际装货时间完毕', 'aaa');
INSERT INTO `hl_order_status` VALUES ('29', '4', '1533625473', null, '2', '录入实际装货时间完毕', 'aaa');
INSERT INTO `hl_order_status` VALUES ('30', '5', '1533625914', null, '1', '申报柜号完毕', 'aaa');
INSERT INTO `hl_order_status` VALUES ('31', '50', '1534729410', '1', null, '录入配船完毕1', 'aaa');
INSERT INTO `hl_order_status` VALUES ('32', '50', '1534729410', null, '1', '录入配船完毕1', 'aaa');
INSERT INTO `hl_order_status` VALUES ('33', '50', '1534729443', '1', null, '录入待到港完毕1', 'aaa');
INSERT INTO `hl_order_status` VALUES ('34', '50', '1534729443', null, '1', '录入待到港完毕1', 'aaa');
INSERT INTO `hl_order_status` VALUES ('35', '80', '1534729721', '1', null, '录入待卸船完毕1', 'aaa');
INSERT INTO `hl_order_status` VALUES ('36', '80', '1534729721', null, '1', '录入待卸船完毕1', 'aaa');
INSERT INTO `hl_order_status` VALUES ('37', '2', '1534731900', '7', null, '输入运单号完毕', 'aaa');
INSERT INTO `hl_order_status` VALUES ('38', '3', '1534731931', null, '9', '录入派车信息完毕', 'aaa');
INSERT INTO `hl_order_status` VALUES ('40', '4', '1534749321', '2', null, '录入实际装货时间完毕', 'aaa');
INSERT INTO `hl_order_status` VALUES ('41', '4', '1534749321', null, '9', '录入实际装货时间完毕', 'aaa');
INSERT INTO `hl_order_status` VALUES ('42', '50', '1534749863', '7', null, '录入配船完毕1', 'aaa');
INSERT INTO `hl_order_status` VALUES ('43', '50', '1534749863', null, '22', '录入配船完毕1', 'aaa');
INSERT INTO `hl_order_status` VALUES ('44', '50', '1534749863', null, '23', '录入配船完毕1', 'aaa');
INSERT INTO `hl_order_status` VALUES ('45', '50', '1534749946', '7', null, '录入待到港完毕1', 'aaa');
INSERT INTO `hl_order_status` VALUES ('46', '50', '1534749946', null, '22', '录入待到港完毕1', 'aaa');
INSERT INTO `hl_order_status` VALUES ('47', '50', '1534749946', null, '23', '录入待到港完毕1', 'aaa');
INSERT INTO `hl_order_status` VALUES ('48', '80', '1534749962', '7', null, '录入待卸船完毕1', 'aaa');
INSERT INTO `hl_order_status` VALUES ('49', '80', '1534749962', null, '22', '录入待卸船完毕1', 'aaa');
INSERT INTO `hl_order_status` VALUES ('50', '80', '1534749962', null, '23', '录入待卸船完毕1', 'aaa');
INSERT INTO `hl_order_status` VALUES ('51', '2', '1534916918', '4', null, '输入运单号完毕', 'aaa');
INSERT INTO `hl_order_status` VALUES ('52', '3', '1534917068', '4', null, '录入派车信息完毕', 'aaa');
INSERT INTO `hl_order_status` VALUES ('53', '3', '1534917068', null, '25', '录入派车信息完毕', 'aaa');
INSERT INTO `hl_order_status` VALUES ('54', '3', '1534917068', null, '26', '录入派车信息完毕', 'aaa');
INSERT INTO `hl_order_status` VALUES ('55', '3', '1534917068', null, '27', '录入派车信息完毕', 'aaa');
...
-- Records of hl_port
-- ----------------------------
INSERT INTO `hl_port` VALUES ('18', '110100002', '擎天柱', '1528773053', '110100');
INSERT INTO `hl_port` VALUES ('19', '110100003', '空城计', '1528773053', '110100');
INSERT INTO `hl_port` VALUES ('20', '110100004', '救世主', '1528773053', '110100');
INSERT INTO `hl_port` VALUES ('21', '110100005', '丑八怪', '1528773053', '110100');
INSERT INTO `hl_port` VALUES ('22', '110100006', '美人计', '1528773053', '110100');
INSERT INTO `hl_port` VALUES ('23', '110100007', '里程碑', '1528773053', '110100');
INSERT INTO `hl_port` VALUES ('24', '110100008', '功德坊', '1528773053', '110100');
INSERT INTO `hl_port` VALUES ('25', '110100009', '败家子', '1528773053', '110100');
INSERT INTO `hl_port` VALUES ('26', '110100010', '打擂台', '1528773053', '110100');
INSERT INTO `hl_port` VALUES ('27', '120100002', '清一色', '1528773098', '120100');
INSERT INTO `hl_port` VALUES ('28', '120100003', '守财奴', '1528773098', '120100');
INSERT INTO `hl_port` VALUES ('29', '120100004', '破天荒', '1528773098', '120100');
INSERT INTO `hl_port` VALUES ('30', '120100005', '莫须有', '1528773098', '120100');
INSERT INTO `hl_port` VALUES ('31', '120100006', '急先锋', '1528773098', '120100');
INSERT INTO `hl_port` VALUES ('32', '120100007', '吝啬鬼', '1528773098', '120100');
INSERT INTO `hl_port` VALUES ('33', '120100008', '口头禅', '1528773098', '120100');
INSERT INTO `hl_port` VALUES ('34', '120100009', '太上皇', '1528773098', '120100');
INSERT INTO `hl_port` VALUES ('35', '110100002', '阿斯蒂芬', '1528785689', '110100');
INSERT INTO `hl_port` VALUES ('36', '110100003', '阿斯蒂芬', '1528785689', '110100');
INSERT INTO `hl_port` VALUES ('37', '110100004', '速读法', '1528785689', '110100');
INSERT INTO `hl_port` VALUES ('38', '440400002', '发生的', '1528785730', '440400');
INSERT INTO `hl_port` VALUES ('39', '440400003', '速读法', '1528785730', '440400');
INSERT INTO `hl_port` VALUES ('40', '440400004', '撒旦发射', '1528785730', '440400');
INSERT INTO `hl_port` VALUES ('41', '440400005', '速读法速', '1528785730', '440400');
...
-- ----------------------------
INSERT INTO `hl_salesman` VALUES ('1', 'sales1', 'yw001', '阿斯达斯', 'e10adc3949ba59abbe56e057f20f883e', '0', '0', '99999', 'aaa@qq.com', '1', '', '2147483647');
INSERT INTO `hl_salesman` VALUES ('2', 'sales2', 'yw002', '李四', 'e10adc3949ba59abbe56e057f20f883e', '0', '0', '11111111', 'ssssi@qq.com', '1', '', '2147483647');
INSERT INTO `hl_salesman` VALUES ('3', 'sales3', 'yw003', '王五', 'e10adc3949ba59abbe56e057f20f883e', '0', '1529371849', '10086123', 'wangwu@qq.com', '1', '', '2018');
INSERT INTO `hl_salesman` VALUES ('4', 'sales4', 'yw004', '钱六', 'e10adc3949ba59abbe56e057f20f883e', '0', '0', '10086', 'aaa@qq.com', '1', null, '2147483647');
INSERT INTO `hl_salesman` VALUES ('5', 'sales5', 'yw005', '马九', 'e10adc3949ba59abbe56e057f20f883e', '0', '0', '10086', 'aaa@qq.com', '1', null, '2147483647');
INSERT INTO `hl_salesman` VALUES ('6', 'sales6', 'yw006', '李七', 'e10adc3949ba59abbe56e057f20f883e', '0', '0', '1111111', 'asaa@qq.com', '1', null, '2147483647');
INSERT INTO `hl_salesman` VALUES ('8', 'sales7', 'yw007', '哥哥个', 'e10adc3949ba59abbe56e057f20f883e', '0', '0', '10086', 'aaa@qq.com', '1', null, '2147483647');
...
-- ----------------------------
INSERT INTO `hl_sales_member` VALUES ('1', 'yw001', 'kehu001', null, null, '阿斯达斯', '客户王老五');
...
INSERT INTO `hl_seaprice` VALUES ('15', '27', '2', '5000.00', '8000.00', '1529510400', '1529683200', 'bbbb_14', '5', '1529942400', '1530201600', '0', '1529561210');
INSERT INTO `hl_seaprice` VALUES ('16', '26', '2', '1125.00', '11256.00', '1529510400', '1529942400', 'bbbc', '5', '1529942400', '1530201600', '0', '1529565619');
INSERT INTO `hl_seaprice` VALUES ('17', '19', '1', '400.00', '400.00', '1528732800', '1530201600', 'aaab_1', '5', '1529164800', '1529424000', '1', '1530172869');
INSERT INTO `hl_seaprice` VALUES ('18', '28', '1', '400.00', '400.00', '1528732800', '1530201600', 'aaab_1', '5', '1529164800', '1529424000', '1', '1530172869');
...
-- ----------------------------
INSERT INTO `hl_sea_bothend` VALUES ('1', '110100002', '440400005', '1', null);
INSERT INTO `hl_sea_bothend` VALUES ('2', '110100003', '110100002', '2', null);
INSERT INTO `hl_sea_bothend` VALUES ('3', '110100004', '110100003', '3', null);
INSERT INTO `hl_sea_bothend` VALUES ('4', '110100005', '110100004', '4', null);
INSERT INTO `hl_sea_bothend` VALUES ('5', '110100006', '110100005', '5', null);
INSERT INTO `hl_sea_bothend` VALUES ('6', '110100007', '110100006', '6', null);
INSERT INTO `hl_sea_bothend` VALUES ('7', '110100008', '110100007', '7', null);
INSERT INTO `hl_sea_bothend` VALUES ('8', '110100009', '110100008', '8', null);
INSERT INTO `hl_sea_bothend` VALUES ('9', '110100010', '110100009', '9', null);
INSERT INTO `hl_sea_bothend` VALUES ('10', '120100002', '110100010', '10', null);
INSERT INTO `hl_sea_bothend` VALUES ('11', '120100003', '120100002', '11', null);
INSERT INTO `hl_sea_bothend` VALUES ('12', '120100004', '120100003', '12', null);
INSERT INTO `hl_sea_bothend` VALUES ('13', '120100005', '120100004', '13', null);
INSERT INTO `hl_sea_bothend` VALUES ('14', '120100006', '120100005', '14', null);
INSERT INTO `hl_sea_bothend` VALUES ('15', '120100007', '120100006', '15', null);
INSERT INTO `hl_sea_bothend` VALUES ('16', '120100008', '120100007', '16', null);
INSERT INTO `hl_sea_bothend` VALUES ('17', '120100009', '120100008', '17', null);
INSERT INTO `hl_sea_bothend` VALUES ('18', '110100002', '120100009', '18', null);
INSERT INTO `hl_sea_bothend` VALUES ('19', '110100003', '110100002', '19', null);
INSERT INTO `hl_sea_bothend` VALUES ('20', '110100004', '110100003', '20', null);
INSERT INTO `hl_sea_bothend` VALUES ('21', '440400002', '110100004', '21', null);
INSERT INTO `hl_sea_bothend` VALUES ('22', '440400003', '440400002', '22', null);
...
-- ----------------------------
INSERT INTO `hl_sea_middle` VALUES ('1', '1', '110100002', '1', null);
INSERT INTO `hl_sea_middle` VALUES ('2', '1', '110100003', '2', null);
INSERT INTO `hl_sea_middle` VALUES ('3', '1', '110100004', '3', null);
INSERT INTO `hl_sea_middle` VALUES ('4', '2', '110100005', '1', null);
INSERT INTO `hl_sea_middle` VALUES ('5', '2', '110100006', '2', null);
INSERT INTO `hl_sea_middle` VALUES ('6', '2', '110100007', '3', null);
INSERT INTO `hl_sea_middle` VALUES ('7', '3', '110100008', '1', null);
INSERT INTO `hl_sea_middle` VALUES ('8', '3', '110100009', '2', null);
INSERT INTO `hl_sea_middle` VALUES ('9', '4', '110100010', '2', null);
INSERT INTO `hl_sea_middle` VALUES ('10', '4', '120100002', '1', null);
INSERT INTO `hl_sea_middle` VALUES ('11', '5', '120100003', '1', null);
INSERT INTO `hl_sea_middle` VALUES ('12', '5', '120100004', '2', null);
INSERT INTO `hl_sea_middle` VALUES ('13', '6', '120100005', '1', null);
INSERT INTO `hl_sea_middle` VALUES ('14', '6', '120100006', '2', null);
INSERT INTO `hl_sea_middle` VALUES ('15', '7', '120100007', '1', null);
INSERT INTO `hl_sea_middle` VALUES ('16', '7', '120100008', '2', null);
INSERT INTO `hl_sea_middle` VALUES ('17', '7', '120100009', '3', null);
INSERT INTO `hl_sea_middle` VALUES ('18', '8', '110100002', '3', null);
INSERT INTO `hl_sea_middle` VALUES ('19', '8', '110100003', '2', null);
INSERT INTO `hl_sea_middle` VALUES ('20', '8', '110100004', '1', null);
INSERT INTO `hl_sea_middle` VALUES ('21', '9', '440400002', '1', null);
INSERT INTO `hl_sea_middle` VALUES ('22', '9', '440400003', '2', null);
INSERT INTO `hl_sea_middle` VALUES ('23', '9', '440400004', '3', null);
INSERT INTO `hl_sea_middle` VALUES ('24', '9', '440400005', '4', null);
INSERT INTO `hl_sea_middle` VALUES ('26', '10', '110100009', '1', null);
INSERT INTO `hl_sea_middle` VALUES ('27', '11', '110100010', '1', null);
INSERT INTO `hl_sea_middle` VALUES ('28', '12', '120100002', '1', null);
INSERT INTO `hl_sea_middle` VALUES ('29', '13', '120100003', '1', null);
INSERT INTO `hl_sea_middle` VALUES ('30', '14', '120100004', '1', null);
INSERT INTO `hl_sea_middle` VALUES ('31', '14', '120100005', '2', null);
INSERT INTO `hl_sea_middle` VALUES ('32', '14', '110100009', '3', null);
INSERT INTO `hl_sea_middle` VALUES ('33', '15', '110100010', '1', null);
INSERT INTO `hl_sea_middle` VALUES ('34', '16', '120100002', '1', null);
INSERT INTO `hl_sea_middle` VALUES ('35', '17', '120100003', '1', null);
INSERT INTO `hl_sea_middle` VALUES ('36', '17', '120100004', '2', null);
INSERT INTO `hl_sea_middle` VALUES ('37', '18', '110100005', '1', '1528965817');
INSERT INTO `hl_sea_middle` VALUES ('38', '18', '110100006', '2', '1528965817');
INSERT INTO `hl_sea_middle` VALUES ('39', '18', '110100004', '3', '1528965817');
INSERT INTO `hl_sea_middle` VALUES ('40', '19', '110100005', '1', '1528965845');
...
-- ----------------------------
INSERT INTO `hl_shipcompany` VALUES ('1', '中国黄金海盗船有限公司', '黄金海盗', null);
INSERT INTO `hl_shipcompany` VALUES ('2', '中国海运（集团）总公司', '中海', '铜锣湾码头');
INSERT INTO `hl_shipcompany` VALUES ('3', '中谷海运集团有限公司', '中谷', '广州天河码头');
INSERT INTO `hl_shipcompany` VALUES ('4', '安通国际航运有限公司', '安通', '北京');
INSERT INTO `hl_shipcompany` VALUES ('5', '宁波远洋运输有限公司', '宁波远洋', '宁波码头');
INSERT INTO `hl_shipcompany` VALUES ('6', '洋浦中良海运有限公司', '中良', '洋浦经济开发区');
INSERT INTO `hl_shipcompany` VALUES ('7', '河北远洋运输集团有限公司', ' 河北远洋', '河北远洋');
...
-- ----------------------------
-- Table structure for `hl_ship_order----zzz`
-- ----------------------------
DROP TABLE IF EXISTS `hl_ship_order----zzz`;
CREATE TABLE `hl_ship_order----zzz` (
  `id` int(10) NOT NULL,
  `track_nun` varchar(12) DEFAULT NULL COMMENT '运单号',
  `departure_port` int(10) DEFAULT NULL COMMENT '起运港口',
  `destination_port` int(10) DEFAULT NULL COMMENT '目的港',
  `predict_sail_time` int(12) DEFAULT NULL COMMENT '预计开船时间',
  `ship_go_status` varchar(10) DEFAULT NULL COMMENT '中转一程,大船直航,中止二程',
  `sail_time` int(10) DEFAULT NULL COMMENT '实际开船时间',
  `boat_name` varchar(10) DEFAULT NULL COMMENT '船名',
  `boat_code` varchar(10) DEFAULT NULL COMMENT '船的code',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of hl_ship_order----zzz
-- ----------------------------
...
INSERT INTO `hl_ship_port` VALUES ('18', '120100005', '3', '1');
...
-- ----------------------------
-- Table structure for `hl_ship_port_city-aa`
-- ----------------------------
DROP TABLE IF EXISTS `hl_ship_port_city-aa`;
CREATE TABLE `hl_ship_port_city-aa` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `city_id` varchar(200) DEFAULT NULL COMMENT '鍩庡競code',
  `city_name` varchar(200) DEFAULT NULL COMMENT '鍩庡競鍚嶅瓧',
  `port_id` varchar(200) DEFAULT NULL COMMENT '娓彛id',
  `ship_id` int(20) NOT NULL COMMENT '鑸瑰叕鍙竤hipcompany琛ㄧ殑Id',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=15 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of hl_ship_port_city-aa
-- ----------------------------
INSERT INTO `hl_ship_port_city-aa` VALUES ('2', null, '', '2,4,5,1', '2');
INSERT INTO `hl_ship_port_city-aa` VALUES ('3', '1,2,3', '', '7,8,9,1', '3');
INSERT INTO `hl_ship_port_city-aa` VALUES ('4', '4,5', '', '4,5,8,1', '4');
INSERT INTO `hl_ship_port_city-aa` VALUES ('8', '7,8,9', '', '1,2,3', '8');
INSERT INTO `hl_ship_port_city-aa` VALUES ('10', '4,5', '', '1,8,10', '10');
INSERT INTO `hl_ship_port_city-aa` VALUES ('11', '1,2,3', '', '4,8,15', '11');
INSERT INTO `hl_ship_port_city-aa` VALUES ('13', '7,8,9', '', '4,6,15', '9');
INSERT INTO `hl_ship_port_city-aa` VALUES ('14', '12,5', '', '5,8,15', '8');
...
-- ----------------------------
INSERT INTO `hl_ship_route` VALUES ('1', '1', '1', '1514736000');
INSERT INTO `hl_ship_route` VALUES ('2', '2', '2', '1514736000');
INSERT INTO `hl_ship_route` VALUES ('3', '3', '3', '1514736000');
INSERT INTO `hl_ship_route` VALUES ('4', '4', '2', '1514736000');
INSERT INTO `hl_ship_route` VALUES ('5', '5', '5', '1514736000');
INSERT INTO `hl_ship_route` VALUES ('6', '8', '8', '1528965845');
INSERT INTO `hl_ship_route` VALUES ('7', '6', '4', '1514736000');
INSERT INTO `hl_ship_route` VALUES ('8', '7', '5', '1514736000');
INSERT INTO `hl_ship_route` VALUES ('9', '8', '7', '1514736000');
INSERT INTO `hl_ship_route` VALUES ('10', '9', '8', '1514736000');
INSERT INTO `hl_ship_route` VALUES ('11', '10', '3', '1514736000');
INSERT INTO `hl_ship_route` VALUES ('12', '9', '4', '1514736000');
INSERT INTO `hl_ship_route` VALUES ('13', '8', '5', '1514736000');
INSERT INTO `hl_ship_route` VALUES ('14', '7', '6', '1514736000');
INSERT INTO `hl_ship_route` VALUES ('15', '6', '8', '1514736000');
INSERT INTO `hl_ship_route` VALUES ('16', '5', '9', '1514736000');
INSERT INTO `hl_ship_route` VALUES ('17', '4', '10', '1514736000');
...
INSERT INTO `hl_ship_route` VALUES ('25', '7', '7', '1514736000');
...
INSERT INTO `hl_user` VALUES ('3', 'aaa', '王五', 'e10adc3949ba59abbe56e057f20f883e', '0', '1535250808', '10086123', 'wangwu@qq.com', '0', '', '2018');
...
INSERT INTO `hl_user` VALUES ('7', 'eeee', '老八', 'e10adc3949ba59abbe56e057f20f883e', '0', '0', '10086', 'aaa@qq.com', '0', null, '2147483647');
INSERT INTO `hl_user` VALUES ('8', 'fff', '哥哥个', 'e10adc3949ba59abbe56e057f20f883e', '0', '0', '10086', 'aaa@qq.com', '0', null, '2147483647');
