<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:85:"E:\xampp\htdocs\xinjia\tp5\public/../application/admin\view\listOrder\list_cargo.html";i:1533649520;s:68:"E:\xampp\htdocs\xinjia\tp5\application\admin\view\public\header.html";i:1527898250;}*/ ?>
<!doctype html>
<html lang="en">
<head>
	<meta charset="UTF-8">
    ...
    <div class="nei layui-col-md12">
        ...
        <div class="cen">
            ...
            <div class="layui-col-md1">
                <p class="a_niu">
                    <a title="录入派车信息" onclick="x_admin_show('<?php echo $vo['order_num']; ?>录入配船','<?php echo url('Order/cargoPlan'); ?>?order_num=<?php echo $vo['order_num']; ?>&container_code=<?php echo $vo['container_code']; ?>',1200,400)" href="javascript:;">确认</a>
                </p>
                <p class="a_niu">
