<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:78:"E:\xampp\htdocs\xinjia\tp5\public/../application/admin\view\public\middle.html";i:1527161015;s:84:"E:\xampp\htdocs\xinjia\tp5\public/../application/admin\view\Member\company_edit.html";i:1527161014;s:68:"E:\xampp\htdocs\xinjia\tp5\application\admin\view\public\header.html";i:1524122628;}*/ ?>
<!doctype html>
<html lang="en">
<head>
	<meta charset="UTF-8">
            ...
            <div class="route layui-row">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-col-xs12">
                        <input type="text" name="title" lay-verify="title" autocomplete="off" placeholder="请输入账号" class="layui-input" value="广州散了科技公司">
                    </div>
                </div>
                <!-- 密码 -->
                <div class="layui-form-item">
