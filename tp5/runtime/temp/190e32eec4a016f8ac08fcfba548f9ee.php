<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:83:"E:\xampp\htdocs\xinjia\tp5\public/../application/admin\view\Order\order_center.html";i:1533036755;s:68:"E:\xampp\htdocs\xinjia\tp5\application\admin\view\public\header.html";i:1527898250;}*/ ?>
<!doctype html>
<html lang="en">
<head>
	<meta charset="UTF-8">
  ...
  <body>
    ...
    $(document).ready(function() {
        ...
        yemian('a4','b4' , "<?php echo url('admin/Order/listBaogui'); ?>")
        yemian('a5','b5' , "<?php echo url('admin/Order/listCargo'); ?>")
    });
