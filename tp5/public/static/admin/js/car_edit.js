...
//            js_ship=JSON.parse(js_ship);
        ...
        //展示原有的船公司和港口和优势路线
         function oldshipPort(){
            ...
            //加载原有的优势路线城市
           console.log((shipPort['city_code']['0']==null));
           if(shipPort['city_code']['0']!==null){
            ...
            //加载原有的船公司
          //  console.log(shipPort['ship_id'].length)
            if((shipPort['ship_id'].length)>0){
...
//             mark.appendChild(nextbtn);
        ...
        function ajaxdata(){
           ...
           dataArray[0]['company_name']=company_name;
