...
CREATE TABLE `hl_car_receive` (
  ...
  `load_time` varchar(12) DEFAULT NULL COMMENT '装货时间',
  PRIMARY KEY (`id`)
...
-- ----------------------------
INSERT INTO `hl_car_receive` VALUES ('1', null, null, '瓦斯蒂法', '发生的', '654a54', 'as6f64', '6468', '46', null, '4684684', '阿德法', '1530720000');
INSERT INTO `hl_car_receive` VALUES ('2', null, null, '阿双方都是', '斯噶', '54afs6d', '464asd', '468468fs', '4', null, '68464646', '打发似的', '1531843200');
INSERT INTO `hl_car_receive` VALUES ('3', null, null, '撒旦发射', '速度', '6a54sdfa', '6464', '64684684', '46', null, '4646486', '阿斯蒂芬', '1531929600');
INSERT INTO `hl_car_receive` VALUES ('4', null, null, '瓦斯蒂法', '发生的', '654a54', 'as6f64', '6468', '46', null, '4684684', '阿德法', '1530720000');
INSERT INTO `hl_car_receive` VALUES ('5', null, null, '阿双方都是', '斯噶', '54afs6d', '464asd', '468468fs', '4', null, '68464646', '打发似的', '1531843200');
INSERT INTO `hl_car_receive` VALUES ('6', null, null, '撒旦发射', '速度', '6a54sdfa', '6464', '64684684', '46', null, '4646486', '阿斯蒂芬', '1531929600');
INSERT INTO `hl_car_receive` VALUES ('7', null, null, 'asdf', 'asfdf', 'fasdf', 'asdfas', 'sdfasd', '0', null, '0', 'afsdfafsd', '0');
INSERT INTO `hl_car_receive` VALUES ('8', null, null, 'asdf', 'asfdf', 'fasdf', 'asdfas', 'sdfasd', '0', null, '0', 'afsdfafsd', '0');
INSERT INTO `hl_car_receive` VALUES ('9', null, null, 'asdf', 'asfdf', 'fasdf', 'asdfas', 'sdfasd', '0', null, '0', 'afsdfafsd', '1530633600');
INSERT INTO `hl_car_receive` VALUES ('10', null, null, 'asdf', 'asfdf', 'fasdf', 'asdfas', 'sdfasd', '0', null, '0', 'afsdfafsd', '1530633600');
INSERT INTO `hl_car_receive` VALUES ('11', null, null, 'asdf', 'asfdf', 'fasdf', 'asdfas', 'sdfasd', '0', null, '0', 'afsdfafsd', '1530633600');
...
-- ----------------------------
INSERT INTO `hl_driver` VALUES ('0', '老司机', '350301198906180060', '18575280024');
...
INSERT INTO `hl_order_father` VALUES ('4', '1531118326kehu001205', '木头', '1', '3', '100', '50', '1', '卖家必须要发货速度块', '1531118326', '1', '1', 'kehu001', '3');
...
-- ----------------------------
INSERT INTO `hl_order_son` VALUES ('1', '1531118326kehu001205', 'PASU5884178321', '0', '3', null, null, null);
INSERT INTO `hl_order_son` VALUES ('2', '1531118326kehu001205', 'PASU5884178322', '1', '3', null, null, null);
INSERT INTO `hl_order_son` VALUES ('3', '1531118326kehu001205', 'PASU5884178323', '2', '3', null, null, null);
INSERT INTO `hl_order_son` VALUES ('4', '1531118326kehu001205', '1111', '0', '3', null, null, null);
INSERT INTO `hl_order_son` VALUES ('5', '1531118326kehu001205', '1111', '1', '3', null, null, null);
INSERT INTO `hl_order_son` VALUES ('6', '1531118326kehu001205', '1111', '2', '3', null, null, null);
...
-- ----------------------------
-- Table structure for `hl_ship`
-- ----------------------------
DROP TABLE IF EXISTS `hl_ship`;
CREATE TABLE `hl_ship` (
  `id` int(11) NOT NULL,
  `oder_id` varchar(11) DEFAULT NULL COMMENT '订单id',
  `ship_name` varchar(11) DEFAULT NULL COMMENT '船名',
  `sail_time` datetime DEFAULT NULL COMMENT '实际开船时间',
  `sail_etd` datetime DEFAULT NULL COMMENT '预计开船时间',
  `sail_status` varchar(20) DEFAULT NULL COMMENT '航行状态分中转1程中转2程或者直航',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
-- Records of hl_ship
-- ----------------------------
INSERT INTO `hl_ship` VALUES ('1', null, null, null, null, null);
...
-- ----------------------------
DROP TABLE IF EXISTS `hl_ship_order`;
CREATE TABLE `hl_ship_order` (
  `id` int(10) NOT NULL,
...
INSERT INTO `hl_user` VALUES ('3', 'aaa', '王五', 'e10adc3949ba59abbe56e057f20f883e', '0', '1532310977', '10086123', 'wangwu@qq.com', '0', '', '2018');
