<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:77:"E:\xampp\htdocs\xinjia\tp5\public/../application/admin\view\Car\car_list.html";i:1525328855;s:68:"E:\xampp\htdocs\xinjia\tp5\application\admin\view\public\header.html";i:1524122628;}*/ ?>
    <!doctype html>
<html lang="en">
<head>
	<meta charset="UTF-8">
    ...
    <tbody >
      ...
      <?php if(is_array($carlist) || $carlist instanceof \think\Collection || $carlist instanceof \think\Paginator): $i = 0; $__LIST__ = $carlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;  //将status(1禁用2正常) 和 symbiosis(1为中止2为暂无3临时4长期合作) 的状态转成汉字
        ...
        ?>
         <tr >
            <td>
             <div class="layui-unselect layui-form-checkbox" lay-skin="primary" data-id='<?php echo $vo['cs_id']; ?>'><i class="layui-icon">&#xe605;</i></div>
            </td>
            <td class="tdata"><?php echo $vo['cs_id']; ?></td>
            ...
            <td class="td-manage">
              <a title="查看" onclick="x_admin_show('查看 <?php echo $vo['car_name']; ?>','<?php echo url('Car/car_info'); ?>?id=<?php echo $vo['cs_id']; ?>',700,400)" href="javascript:;">
                  <i class="layui-icon">&#xe649;</i>
              </a>  
              <a title="编辑"  onclick="x_admin_show('编辑 <?php echo $vo['car_name']; ?>','<?php echo url('Car/car_edit'); ?>?id=<?php echo $vo['cs_id']; ?>',800,400)" href="javascript:;">
                <i class="layui-icon">&#xe642;</i>
              </a>
              <a title="删除" onclick="member_del(this,'<?php echo $vo['cs_id']; ?>') " href="javascript:;">
                <i class="layui-icon">&#xe640;</i> 
              </a>
            </td>
          </tr>
