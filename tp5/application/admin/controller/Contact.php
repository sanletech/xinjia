...
//        $sql2="select * from hl_cardata  CD"
//                . "left join hl_car_port CP on CP.car_id = CD.car_id " 
//                . "left join hl_port P      on CP.port_id = P.id"      //查询港口名字
//                . "left join hl_car_ship CS on CS.  ";
