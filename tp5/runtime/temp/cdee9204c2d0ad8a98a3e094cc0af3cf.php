<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:78:"E:\xampp\htdocs\xinjia\tp5\public/../application/admin\view\public\middle.html";i:1525947884;s:81:"E:\xampp\htdocs\xinjia\tp5\public/../application/admin\view\Price\route_edit.html";i:1526027140;s:68:"E:\xampp\htdocs\xinjia\tp5\application\admin\view\public\header.html";i:1525660218;}*/ ?>
<!doctype html>
<html lang="en">
<head>
	<meta charset="UTF-8">
      ...
      <div class="route layui-row">
        ...
        <div class="layui-form-item">
          ...
          <div class="layui-input-block">
            <input type="text" name="title" lay-verify="title" autocomplete="off" placeholder="请输入公司" class="layui-input" value="中远海船务">
          </div>
        </div>
        <!-- 航线港口 -->
        <div class="layui-form-item">
          ...
          <div class="layui-input-inline gang" style="width: 190px;">
            <input type="text" name="price_min" placeholder="港口" autocomplete="off" class="layui-input" value="南沙">
          </div>
          <div class="layui-form-mid">—</div>
          <div class="layui-input-inline gang" style="width: 190px;">
            <input type="text" name="price_max" placeholder="港口" autocomplete="off" class="layui-input" value="天津">
          </div>
        </div>
        <!-- 20GP -->
        <div class="layui-form-item">
        ...
        <div class="layui-form-item">
          ...
          <div class="layui-input-block">
            <input type="text" name="date" id="date" lay-verify="date" placeholder="yyyy-MM-dd" autocomplete="off" class="layui-input" value="2018-3-6">
          </div>
        </div>
        <!-- 截单时间 -->
        <div class="layui-form-item">
          ...
          <div class="layui-input-block">
            <input type="text" name="date1" id="date1" lay-verify="date" placeholder="yyyy-MM-dd" autocomplete="off" class="layui-input" value="2018-3-10">
          </div>
        </div>
        <!-- 船名 -->
        <div class="layui-form-item">
