<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:77:"E:\xampp\htdocs\xinjia\tp5\public/../application/index\view\login\logout.html";i:1529718403;s:66:"E:\xampp\htdocs\xinjia\tp5\application\index\view\public\head.html";i:1530532388;}*/ ?>
<!-- 注册 -->
<!DOCTYPE html>
<html>
<head>
        ...
        <form class="" action="index.html" method="post">
          <div class="layui-form-item">
            <div class="layui-col-xs12 gu">
              <div class="hong">*</div>
              <input type="text" name="title" class="layui-col-xs12" placeholder="请输入您的姓名" required="required">
            </div>

            <div class="layui-col-xs12 gu">
              <div class="hong">*</div>
              <input type="text" name="title" class="layui-col-xs12" placeholder="请输入您的手机号码" required="required">
            </div>
            ...
            <div class="layui-col-xs12 gu">
              <div class="hong">*</div>
              <input type="text" name="title" class="layui-col-xs12" placeholder="请输入您的密码" required="required">
            </div>

            <div class="layui-col-xs12 gu">
              <div class="hong">*</div>
              <input type="text" name="title" class="layui-col-xs12" placeholder="请再次确认密码" required="required">
            </div>

            <div class="layui-col-xs12 gu">
              <input type="text" name="title" class="layui-col-xs12" placeholder="请输入您的企业名">
            </div>

            <div class="layui-col-xs12 gu">
              <input type="text" name="title" class="layui-col-xs12" placeholder="请输入推荐人">
            </div>
          </div>

          <div class="sub layui-col-xs12">
            <button type="submit" class="layui-btn layui-btn-fluid" name="button">提交注册</button>
          </div>
