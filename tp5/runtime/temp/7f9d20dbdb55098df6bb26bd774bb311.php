<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:78:"E:\xampp\htdocs\xinjia\tp5\public/../application/admin\view\public\middle.html";i:1526047940;s:79:"E:\xampp\htdocs\xinjia\tp5\public/../application/admin\view\Ship\ship_edit.html";i:1526224762;s:68:"E:\xampp\htdocs\xinjia\tp5\application\admin\view\public\header.html";i:1526047940;}*/ ?>
<!doctype html>
<html lang="en">
<head>
	<meta charset="UTF-8">
        ...
        <form class="layui-form" id="editform" method="post">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" name="ship_short_name" class="layui-input" value="<?php echo $vo['ship_short_name']; ?>">
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label">
                ...
                <div class="layui-input-inline">
                    <input type="text" name="ship_name" class="layui-input" value="<?php echo $vo['ship_name']; ?>">
                </div>
            </div>
...
//       //加载 所有的港口名字和相应的城市code
        ...
        //ajax url生成
       var url='<?php echo url('admin/ship/toEdit'); ?>';
