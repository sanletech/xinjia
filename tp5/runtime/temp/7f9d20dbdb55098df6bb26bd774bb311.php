<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:78:"E:\xampp\htdocs\xinjia\tp5\public/../application/admin\view\public\middle.html";i:1525868736;s:79:"E:\xampp\htdocs\xinjia\tp5\public/../application/admin\view\Ship\ship_edit.html";i:1524818724;s:68:"E:\xampp\htdocs\xinjia\tp5\application\admin\view\public\header.html";i:1524122628;}*/ ?>
<!doctype html>
<html lang="en">
<head>
	<meta charset="UTF-8">
    ...
    <div class="x-body">
        <form class="layui-form" id="editform" method="post">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" id="company_name" name="company_name" class="layui-input" value="<?php echo $car['company_name']; ?>">
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label">
 ...
 <script>
    ...
    //加载 所有的船公司名字简称和相应的id
       ...
       //加载 所有的港口名字和相应的城市code
        ...
        //ajax url生成
       var url='<?php echo url('admin/Contact/toEdit'); ?>';
       //修改的车队ID 
